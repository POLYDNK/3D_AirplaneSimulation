...
namespace Midterm_Project
{
    class CubeSide
    {
        ...
        /// <summary>
        /// Define a side of a cube in 3D space. This cube side is drawn from point p1 to point p2.
        /// </summary>
        ...
        public CubeSide(Point3D p1, Point3D p2, Color color)
        {
            // Create model
            CreateModel(p1, p2);
        ...
        public CubeSide(Point3D p1, Point3D p2, BitmapImage image)
        {
            // Create Model
            CreateModel(p1, p2);
            myModel.Geometry = myMesh;
        ...
        /// <param name="p1">Point to start drawing from</param>
        /// <param name="p2">Point to draw to</param>
        /// <param name="brush">Brush to paint texture</param>
        public CubeSide(Point3D p1, Point3D p2, ImageBrush brush)
        {
            // Create Model
            CreateModel(p1, p2);
            myModel.Geometry = myMesh;
            ...
            // Create new material from brush then apply it to the model
            myMaterial = new DiffuseMaterial(brush);
            myModel.Material = myMaterial;
            myModel.BackMaterial = myMaterial;
            myVisual.Content = myModel;
        }

        private void CreateModel(Point3D p1, Point3D p2)
        {
            // Initialize Model, Visual, and Mesh
            ...
            Point3D v2 = new Point3D(p2.X, p1.Y, p2.Z);
            Point3D v3 = new Point3D(p1.X, p2.Y, p1.Z);
